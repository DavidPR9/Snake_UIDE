...
"""#funcion para que el usuario ponga su nombre 
...
ventana = tk.Tk()
ventana.title("Snake:por_David_Proaño")
...
#boton marcadores
Boton = tk.Button(ventana,image=boton_marcadores, text=("MARCADORES"),font=("Arial",15, "bold"), compound="center")
Boton.place(x=260, y=160)
